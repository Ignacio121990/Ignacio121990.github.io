function Completo(){
  ...
  this.brazoI = new THREE.Mesh(new THREE.CylinderGeometry(0.6,0.6,1),new THREE.MeshLambertMaterial({map:brazos}));
  this.brazoD = new THREE.Mesh(new THREE.CylinderGeometry(0.6,0.6,1),new THREE.MeshLambertMaterial({map:brazos}));
