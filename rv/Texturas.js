function Completo(){
  ...
  this.pieI = new THREE.Mesh(new THREE.BoxGeometry(0.5,1,3),new THREE.MeshLambertMaterial({map:pies}));
  this.pieD = new THREE.Mesh(new THREE.BoxGeometry(0.5,1,3),new THREE.MeshLambertMaterial({map:pies}));
