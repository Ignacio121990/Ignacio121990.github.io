function Completo(){
  ...
  this.pieI = new THREE.Mesh(new THREE.BoxGeometry(2,0.5,1),new THREE.MeshLambertMaterial({map:pies}));
  this.pieD = new THREE.Mesh(new THREE.BoxGeometry(2,0.5,1),new THREE.MeshLambertMaterial({map:pies}));
